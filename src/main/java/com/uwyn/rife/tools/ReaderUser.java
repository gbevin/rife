 ...
 * executed by methods that allow interaction with a <code>Reader</code>.
...
public abstract class ReaderUser<ResultType, DataType> implements Cloneable
{
     ...
     * rethrown.
     *
     * @throws com.uwyn.rife.tools.exceptions.InnerClassException
     *          when a checked exception needs to be
