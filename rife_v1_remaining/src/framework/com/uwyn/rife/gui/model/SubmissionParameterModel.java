 ...
 * $Id: SubmissionParameterModel.java 3918 2008-04-14 17:35:35Z gbevin $
 */
package com.uwyn.rife.gui.model;

import com.uwyn.rife.gui.model.exceptions.GuiModelException;

public class SubmissionParameterModel extends ParticlePropertyModel
{
	public SubmissionParameterModel(SubmissionModel element, String name)
	...
	public boolean equals(Object object)
	{
		if (object instanceof ParticlePropertyModel)
		{
			...
			if (property.getParticle() == getParticle() &&
				object instanceof SubmissionParameterModel &&
	...
	protected static ParticlePropertyModel findConflictingProperty(ParticleModel particle, Class type, String name)
	{
		...
		return particle.getProperty(SubmissionParameterModel.class, name);
	}
}
