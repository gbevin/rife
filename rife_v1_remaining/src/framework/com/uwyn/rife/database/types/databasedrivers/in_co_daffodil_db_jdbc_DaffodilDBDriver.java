...
import com.uwyn.rife.database.types.databasedrivers.Common;
...
public class in_co_daffodil_db_jdbc_DaffodilDBDriver extends Common implements SqlConversion
{
	public String getSqlValue(Object value)
	{
		...
		{
			return "TIME '" + StringUtils.encodeSql(value.toString()) + "'";
		}
		else if (value instanceof Timestamp)
		{
			return "TIMESTAMP '" + StringUtils.encodeSql(value.toString()) + "'";
		}
		else if (value instanceof java.sql.Date)
		{
			SimpleDateFormat dateformat = new SimpleDateFormat("yyyy-MM-dd");
			dateformat.setTimeZone(RifeConfig.Tools.getDefaultTimeZone());
			return "DATE '" + StringUtils.encodeSql(dateformat.format(value)) + "'";
		}
		else if (value instanceof Date)
		{
			return "TIMESTAMP '" + StringUtils.encodeSql(new Timestamp(((Date)value).getTime()).toString()) + "'";
		}
		else if (value instanceof Calendar)
		{
			return "TIMESTAMP '" + StringUtils.encodeSql(new Timestamp(((Calendar)value).getTime().getTime()).toString()) + "'";
		}
	...
	throws DatabaseException
	{
		...
		{
			super.setTypedParameter(statement, parameterIndex, targetType, name, value, constrained);
		}
	}
}
