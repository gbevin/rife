 ...
 * $Id: ManyToOneAssociationList.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
class ManyToOneAssociationList<E> extends AbstractManyToOneAssociationCollection<E> implements List<E>
{
	private List<E> mDelegate;
	
	ManyToOneAssociationList(AbstractGenericQueryManager manager, int objectId, ManyToOneAssociationDeclaration declaration)
	{
	...
	protected void ensurePopulatedDelegate()
	{
		if (null == mDelegate)
		{
			mDelegate = restoreManyToOneAssociations();
		}
	}
