 ...
 * $Id: CreateSequence.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
public class CreateSequence extends AbstractQuery implements Cloneable
{
	...
	throws DbQueryException
	{
		if (null == mSql)
		{
			...
			{
				Template template = TemplateFactory.SQL.get("sql."+StringUtils.encodeClassname(mDatasource.getAliasedDriver())+".create_sequence");
				...
				if (0 == mSql.length())
				{
					throw new UnsupportedSqlFeatureException("CREATE SEQUENCE", mDatasource.getAliasedDriver());
				}
