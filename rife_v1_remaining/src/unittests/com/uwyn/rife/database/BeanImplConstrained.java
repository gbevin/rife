 ...
 * $Id: BeanImplConstrained.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
public class BeanImplConstrained extends Validation
{
	...
	protected void activateValidation()
	{
		...
		addConstraint(new ConstrainedProperty("propertyString").identifier(true).maxLength(30).inList(new String[] {"one", "tw''o", "someotherstring"}).defaultValue("one"));
		...
		addConstraint(new ConstrainedProperty("propertyLongObject").inList(new String[] {"89", "1221", "66875", "878"}));
