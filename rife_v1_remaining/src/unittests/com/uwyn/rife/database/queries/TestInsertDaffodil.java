 ...
 * $Id: TestInsertDaffodil.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
public class TestInsertDaffodil extends TestInsert
{
	public TestInsertDaffodil(String name)
	{
		super(name);
	}
	...
	{
		Insert query = new Insert(mDaffodil);
		assertNotNull(query);
		try
		{
			query.getSql();
	...
	public void testParameterDaffodil()
	{
		Insert query = new Insert(mDaffodil);
		query.into("tablename")
			.fieldParameter("col1");
	...
	public void testFieldCustomDaffodil()
	{
		Insert query = new Insert(mDaffodil);
		query.into("tablename")
			.fieldCustom("propertySqlDate", "curtimestamp()");
		assertEquals(query.getSql(), "INSERT INTO tablename (propertySqlDate) VALUES (curtimestamp())");
		assertTrue(execute(query));
	}

	public void testFieldsDaffodil()
	{
		Calendar cal = Calendar.getInstance();
		cal.set(2002, 7, 19, 12, 17, 52);
		cal.set(Calendar.MILLISECOND, 462);
	...
	public void testFieldParametersDaffodil()
	{
		Insert query = new Insert(mDaffodil);
		query.into("tablename");
	...
	public void testFieldParametersMixedDaffodil()
	{
		Insert query = new Insert(mDaffodil);
		query.into("tablename");
	...
	public void testFieldsBeanDaffodil()
	{
		Insert query = new Insert(mDaffodil);
		query.into("tablename")
	...
	public void testFieldsBeanConstrainedDaffodil()
	{
		Insert query = new Insert(mDaffodil);
		query.into("tablename")
	...
	public void testFieldsBeanNullValuesDaffodil()
	{
		Insert query = new Insert(mDaffodil);
		query.into("tablename")
	...
	public void testFieldsBeanIncludedDaffodil()
	{
		Insert query = new Insert(mDaffodil);
		query.into("tablename")
		...
		assertEquals(query.getSql(), "INSERT INTO tablename (propertyByte, propertyDouble, propertyShort, propertyStringbuffer, propertyTime) VALUES (89, 53348.34, 43, 'someotherstringbuff', TIME '15:26:14')");
		assertTrue(execute(query));
	}

	public void testFieldsBeanExcludedDaffodil()
	{
		Insert query = new Insert(mDaffodil);
		query.into("tablename")
	...
	public void testFieldsBeanFilteredDaffodil()
	{
		Insert query = new Insert(mDaffodil);
		query.into("tablename")
	...
	public void testMultipleRowsDaffodil()
	{
		Insert query = new Insert(mDaffodil);
		query.into("tablename")
			.field("propertyChar", 'M')
	...
	public void testFieldsParametersBeanDaffodil()
	{
		Insert query = new Insert(mPgsql);
		query.into("tablename")
	...
	public void testFieldsParametersBeanConstrainedDaffodil()
	{
		Insert query = new Insert(mDaffodil);
		query.into("tablename")
	...
	public void testFieldsParametersBeanExcludedDaffodil()
	{
		Insert query = new Insert(mPgsql);
		query.into("tablename")
	...
	public void testInsertSubselectParamsDaffodil()
	{
