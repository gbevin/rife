 ...
 * $Id: TestCreateTableDaffodil.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
public class TestCreateTableDaffodil extends TestCreateTable
{
	public TestCreateTableDaffodil(String name)
	{
		super(name);
	}
	...
	{
		CreateTable query = new CreateTable(mDaffodil);
		assertNotNull(query);
		try
		{
			query.getSql();
	...
	public void testColumnDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename1")
			.column("stringcolumn", String.class)
		...
		assertEquals(query.getSql(), "CREATE TABLE tablename1 (stringcolumn VARCHAR(4192), stringbuffer VARCHAR(4192), characterobject CHAR, booleanobject BOOLEAN, byteobject SMALLINT, doubleobject FLOAT, floatobject FLOAT, integerobject INTEGER, longobject BIGINT, shortobject SMALLINT, bigdecimal NUMERIC, charcolumn CHAR, booleancolumn BOOLEAN, bytecolumn SMALLINT, doublecolumn FLOAT, floatcolumn FLOAT, intcolumn INTEGER, longcolumn BIGINT, shortcolumn SMALLINT, blobcolumn LONG VARBINARY)");
		execute(query);
	}

	public void testColumnPrecisionDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename1")
			.column("stringcolumn", String.class, 255)
		...
		assertEquals(query.getSql(), "CREATE TABLE tablename1 (stringcolumn VARCHAR(255), stringbuffer VARCHAR(100), characterobject CHAR(20), booleanobject BOOLEAN, byteobject SMALLINT, doubleobject FLOAT, floatobject FLOAT, integerobject INTEGER, longobject BIGINT, shortobject SMALLINT, bigdecimal NUMERIC(19,9), charcolumn CHAR(10), booleancolumn BOOLEAN, bytecolumn SMALLINT, doublecolumn FLOAT, floatcolumn FLOAT, intcolumn INTEGER, longcolumn BIGINT, shortcolumn SMALLINT, blobcolumn LONG VARBINARY)");
		execute(query);
	}

	public void testColumnsBeanDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.columns(BeanImpl.class);
		assertEquals(query.getSql(), "CREATE TABLE tablename (propertyBigDecimal NUMERIC, propertyBoolean BOOLEAN, propertyBooleanObject BOOLEAN, propertyByte SMALLINT, propertyByteObject SMALLINT, propertyCalendar TIMESTAMP, propertyChar CHAR, propertyCharacterObject CHAR, propertyDate TIMESTAMP, propertyDouble FLOAT, propertyDoubleObject FLOAT, propertyEnum VARCHAR(255), propertyFloat FLOAT, propertyFloatObject FLOAT, propertyInt INTEGER, propertyIntegerObject INTEGER, propertyLong BIGINT, propertyLongObject BIGINT, propertyShort SMALLINT, propertyShortObject SMALLINT, propertySqlDate DATE, propertyString VARCHAR(4192), propertyStringbuffer VARCHAR(4192), propertyTime TIME, propertyTimestamp TIMESTAMP, CHECK (propertyEnum IS NULL OR propertyEnum IN ('VALUE_ONE','VALUE_TWO','VALUE_THREE')))");
		execute(query);
	}

	public void testColumnsBeanIncludedDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
		...
		assertEquals(query.getSql(), "CREATE TABLE tablename (propertyBigDecimal NUMERIC, propertyByte SMALLINT, propertyFloat FLOAT, propertyStringbuffer VARCHAR(4192), propertyTime TIME)");
		execute(query);
	}

	public void testColumnsBeanExcludedDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
	...
	public void testColumnsBeanPrecisionDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.columns(BeanImpl.class)
	...
	public void testColumnsBeanConstrainedDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
	...
	public void testNullableDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
	...
	public void testDefaultDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename1")
			.column("stringcolumn", String.class, 255)
			...
			.column("longcolumn", long.class, 12)
			.column("shortcolumn", short.class, 9)
			.defaultValue("stringcolumn", "stringDefault")
	...
	public void testTemporaryDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.temporary(true)
	...
	public void testPrimaryKeySimpleDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testPrimaryKeyMultipleDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testPrimaryKeyNamedDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testPrimaryKeyMultipleNamedDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testUniqueSimpleDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testUniqueMultipleDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testUniqueNamedDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testUniqueMultipleNamedDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeySimpleDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeyMultipleDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeySimpleNamedDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeyMultipleNamedDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeyViolationsSingleDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeyViolationsDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeyMultipleViolationsDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testCheckSimpleDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testCheckNamedDaffodil()
	{
		CreateTable query = new CreateTable(mDaffodil);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testCloneDaffodil()
	{
		...
		query.table("tablename")
			...
			.defaultFunction("propertyDate", "curtimestamp()")
