 ...
 * $Id: TestInsertPgsql.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
{
	public TestInsertPgsql(String name)
	{
		super(name);
	}
	...
	public void testFieldsBeanConstrainedPgsql()
	{
		Insert query = new Insert(mPgsql);
		query.into("tablename")
	...
	public void testFieldsParametersBeanConstrainedPgsql()
	{
		Insert query = new Insert(mPgsql);
		query.into("tablename")
