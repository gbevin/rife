 ...
 * $Id: TestInsertMckoi.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
public class TestInsertMckoi extends TestInsert
{
	public TestInsertMckoi(String name)
	{
		super(name);
	}
	...
	{
		Insert query = new Insert(mMckoi);
		assertNotNull(query);
		try
		{
			query.getSql();
	...
	public void testParameterMckoi()
	{
		Insert query = new Insert(mMckoi);
		query.into("tablename")
			.fieldParameter("col1");
	...
	public void testFieldCustomMckoi()
	{
		...
		assertEquals(query.getSql(), "INSERT INTO tablename (propertyInt) VALUES (TONUMBER(DATEOB('Aug 1, 2000')))");
		assertTrue(execute(query));
	}
	...
	public void testMultipleRowsMckoi()
	{
		Insert query = new Insert(mMckoi);
		query.into("tablename")
			.field("propertyChar", 'M')
	...
	public void testInsertSubselectParamsMckoi()
	{
		// mckoi doesn't support insert value subqueries
	}
