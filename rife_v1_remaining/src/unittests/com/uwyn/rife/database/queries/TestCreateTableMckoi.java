 ...
 * $Id: TestCreateTableMckoi.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
public class TestCreateTableMckoi extends TestCreateTable
{
	public TestCreateTableMckoi(String name)
	{
		super(name);
	}
	...
	{
		CreateTable query = new CreateTable(mMckoi);
		assertNotNull(query);
		try
		{
			query.getSql();
	...
	public void testColumnMckoi()
	{
		...
		assertEquals(query.getSql(), "CREATE TABLE tablename1 (stringcolumn TEXT, stringbuffer TEXT, characterobject CHAR, booleanobject BOOLEAN, byteobject SMALLINT, doubleobject FLOAT, floatobject FLOAT, integerobject INTEGER, longobject BIGINT, shortobject SMALLINT, bigdecimal NUMERIC, charcolumn CHAR, booleancolumn BOOLEAN, bytecolumn SMALLINT, doublecolumn FLOAT, floatcolumn FLOAT, intcolumn INTEGER, longcolumn BIGINT, shortcolumn SMALLINT, blobcolumn BLOB)");
		execute(query);
	}

	public void testColumnPrecisionMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename1")
		...
		assertEquals(query.getSql(), "CREATE TABLE tablename1 (stringcolumn VARCHAR(255), stringbuffer VARCHAR(100), characterobject CHAR(20), booleanobject BOOLEAN, byteobject SMALLINT, doubleobject FLOAT, floatobject FLOAT, integerobject INTEGER, longobject BIGINT, shortobject SMALLINT, bigdecimal NUMERIC(19,9), charcolumn CHAR(10), booleancolumn BOOLEAN, bytecolumn SMALLINT, doublecolumn FLOAT, floatcolumn FLOAT, intcolumn INTEGER, longcolumn BIGINT, shortcolumn SMALLINT, blobcolumn BLOB)");
		execute(query);
	}

	public void testColumnsBeanMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
	...
	public void testColumnsBeanIncludedMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
	...
	public void testColumnsBeanExcludedMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
	...
	public void testColumnsBeanFilteredMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
	...
	public void testColumnsBeanPrecisionMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.columns(BeanImpl.class)
	...
	public void testColumnsBeanConstrainedMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
	...
	public void testDefaultFunctionMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename1")
	...
	public void testCustomAttributeMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename1")
			.column("intColumn", Integer.class)
			.customAttribute("intColumn", "INDEX_BLIST");
		assertEquals(query.getSql(), "CREATE TABLE tablename1 (intColumn INTEGER INDEX_BLIST)");
		execute(query);
	}

	public void testTemporaryMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.temporary(true)
	...
	public void testPrimaryKeySimpleMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testPrimaryKeyMultipleMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testPrimaryKeyNamedMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testPrimaryKeyMultipleNamedMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testUniqueSimpleMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testUniqueMultipleMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testUniqueNamedMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testUniqueMultipleNamedMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeySimpleMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeyMultipleMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeySimpleNamedMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeyMultipleNamedMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeyViolationsSingleMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeyViolationsMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeyMultipleViolationsMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testCheckSimpleMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testCheckNamedMckoi()
	{
		CreateTable query = new CreateTable(mMckoi);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testCloneMckoi()
	{
		...
		query.table("tablename")
			...
			.customAttribute("propertyInt", "INDEX_BLIST")
			.temporary(true)
