 ...
 * $Id: TestCreateTableFirebird.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
public class TestCreateTableFirebird extends TestCreateTable
{
	public TestCreateTableFirebird(String name)
	{
		super(name);
	}
	...
	public void setUp()
	{
		...
		// disable the connection pool since Firebird refuses to create foreign
		// keys when more than one connection is present
		mFirebird.setPoolsize(0);
	}

	protected void tearDown() throws Exception
	{
		mFirebird.setPoolsize(5);
		super.tearDown();
	}

	public void testInstantiationFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		assertNotNull(query);
		try
		{
			query.getSql();
	...
	public void testColumnFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
	...
	public void testColumnPrecisionFirebird()
	{
		...
		query.table("tablename1")
			...
			.column("bigdecimal", BigDecimal.class, 18, 9)
	...
	public void testColumnsBeanIncludedFirebird()
	{
		...
		assertEquals(query.getSql(), "CREATE TABLE tablename (propertyBigDecimal NUMERIC, propertyByte SMALLINT, propertyFloat FLOAT, propertyStringbuffer BLOB SUB_TYPE TEXT CHARACTER SET UNICODE_FSS, propertyTime TIME)");
		execute(query);
	}

	public void testColumnsBeanExcludedFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
	...
	public void testColumnsBeanPrecisionFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.columns(BeanImpl.class)
	...
	public void testNullableFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
	...
	public void testDefaultFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename1")
			.column("string", String.class, 255)
	...
	public void testCustomAttributeFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename1")
	...
	public void testTemporaryFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.temporary(true)
	...
	public void testPrimaryKeySimpleFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testPrimaryKeyMultipleFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testPrimaryKeyNamedFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testPrimaryKeyMultipleNamedFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testUniqueSimpleFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testUniqueMultipleFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testUniqueNamedFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testUniqueMultipleNamedFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeySimpleFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeyMultipleFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeySimpleNamedFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeyMultipleNamedFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeyViolationsSingleFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.column("intColumn", int.class)
		...
		{
			assertEquals(e.getFeature(), "ON UPDATE RESTRICT");
		}
		query.clear();
		...
		{
			assertEquals(e.getFeature(), "ON DELETE RESTRICT");
		}
		query.clear();
	...
	public void testForeignKeyViolationsFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testForeignKeyMultipleViolationsFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.column("intColumn", int.class)
			.column("stringColumn", String.class, 50)
			.foreignKey("foreigntable", new String[] {"intColumn", "foreignIntColumn", "stringColumn", "foreignStringColumn"}, CreateTable.SETNULL, CreateTable.SETDEFAULT);
		assertEquals(query.getSql(), "CREATE TABLE tablename (intColumn INTEGER, stringColumn VARCHAR(50), FOREIGN KEY (intColumn, stringColumn) REFERENCES foreigntable (foreignIntColumn, foreignStringColumn) ON UPDATE SET NULL ON DELETE SET DEFAULT)");
		execute(query);
	}

	public void testCheckSimpleFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.column("intColumn", int.class)
	...
	public void testCheckNamedFirebird()
	{
		CreateTable query = new CreateTable(mFirebird);
		query.table("tablename")
			.column("intColumn", int.class)
...
//			.temporary(true)
			...
			.foreignKey("foreigntable", new String[] {"propertyInt", "foreignIntColumn", "propertyString", "foreignStringColumn"}, CreateTable.NOACTION, CreateTable.SETDEFAULT)
