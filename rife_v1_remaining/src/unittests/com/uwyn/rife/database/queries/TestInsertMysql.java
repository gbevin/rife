 ...
 * $Id: TestInsertMysql.java 3936 2008-04-26 12:05:37Z gbevin $
 */
...
{
	public TestInsertMysql(String name)
	{
		super(name);
	}
	...
	public void testHintMysql()
	{
		...
		assertEquals(query.getSql(), "INSERT DELAYED INTO tablename (propertyInt) VALUES (34)");
