 ...
 * $Id: TestUpdateDaffodil.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
public class TestUpdateDaffodil extends TestUpdate
{
	public TestUpdateDaffodil(String name)
	{
		super(name);
	}
	...
	{
		Update query = new Update(mDaffodil);
		assertNotNull(query);
		try
		{
			query.getSql();
	...
	public void testFieldCustomDaffodil()
	{
		...
		assertEquals(query.getSql(), "UPDATE tablename SET propertySqlDate = curtimestamp()");
		assertTrue(execute(query));
	}
	...
	public void testFieldWhereParametersDaffodil()
	{
		Update query = new Update(mDaffodil);
		query.table("tablename");
