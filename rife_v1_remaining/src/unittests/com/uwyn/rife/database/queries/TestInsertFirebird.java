 ...
 * $Id: TestInsertFirebird.java 3937 2008-04-26 14:28:10Z gbevin $
 */
...
public class TestInsertFirebird extends TestInsert
{
	public TestInsertFirebird(String name)
	{
		super(name);
	}
	...
	{
		Insert query = new Insert(mFirebird);
		assertNotNull(query);
		try
		{
			query.getSql();
	...
	public void testParameterFirebird()
	{
		Insert query = new Insert(mFirebird);
		query.into("tablename")
			.fieldParameter("col1");
	...
	public void testMultipleRowsFirebird()
	{
		Insert query = new Insert(mFirebird);
		query.into("tablename")
			.field("propertyChar", 'M')
	...
	public void testInsertSubselectParamsFirebird()
	{
