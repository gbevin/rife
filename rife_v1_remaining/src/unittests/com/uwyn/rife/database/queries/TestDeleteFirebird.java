 ...
 * $Id: TestDeleteFirebird.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
public class TestDeleteFirebird extends TestDelete
{
	public TestDeleteFirebird(String name)
	{
		super(name);
	}
	...
	{
		Delete query = new Delete(mFirebird);
		assertNotNull(query);
		try
		{
			query.getSql();
	...
	public void testDeleteSubselectParamsFirebird()
	{
