 ...
 * $Id: TestDeleteDaffodil.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
public class TestDeleteDaffodil extends TestDelete
{
	public TestDeleteDaffodil(String name)
	{
		super(name);
	}
	...
	{
		Delete query = new Delete(mDaffodil);
		assertNotNull(query);
		try
		{
			query.getSql();
	...
	public void testDeleteSubselectParamsDaffodil()
	{
