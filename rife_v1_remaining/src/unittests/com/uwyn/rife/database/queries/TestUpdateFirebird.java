 ...
 * $Id: TestUpdateFirebird.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
public class TestUpdateFirebird extends TestUpdate
{
	public TestUpdateFirebird(String name)
	{
		super(name);
	}
	...
	{
		Update query = new Update(mFirebird);
		assertNotNull(query);
		try
		{
			query.getSql();
	...
	public void testFieldParametersFirebird()
	{
		Update query = new Update(mFirebird);
		query.table("tablename");
	...
	public void testFieldParametersMixedFirebird()
	{
		Update query = new Update(mFirebird);
		query.table("tablename");
	...
	public void testFieldsFirebird()
	{
		Calendar cal = Calendar.getInstance();
		cal.set(2002, 7, 19, 12, 17, 52);
		cal.set(Calendar.MILLISECOND, 462);
	...
	public void testFieldWhereParametersFirebird()
	{
		Update query = new Update(mFirebird);
		query.table("tablename");
	...
	public void testFieldsBeanFirebird()
	{
		Update query = new Update(mFirebird);
		query.table("tablename")
			.where("propertyInt = 545")
	...
	public void testFieldsBeanConstrainedFirebird()
	{
		Update query = new Update(mFirebird);
		query.table("tablename")
			.where("propertyInt = 545")
	...
	public void testFieldsBeanNullValuesFirebird()
	{
		Update query = new Update(mFirebird);
		query.table("tablename")
			.where("propertyInt = 545")
	...
	public void testFieldsBeanIncludedFirebird()
	{
		Update query = new Update(mFirebird);
		query.table("tablename")
			.where("propertyInt = 545")
	...
	public void testFieldsBeanExcludedFirebird()
	{
		Update query = new Update(mFirebird);
		query.table("tablename")
			.where("propertyInt = 545")
	...
	public void testFieldsBeanFilteredFirebird()
	{
		Update query = new Update(mFirebird);
		query.table("tablename")
			.where("propertyInt = 545")
	...
	public void testFieldsParametersBeanFirebird()
	{
		Update query = new Update(mFirebird);
		query.table("tablename")
	...
	public void testFieldsParametersBeanConstrainedFirebird()
	{
		Update query = new Update(mFirebird);
		query.table("tablename")
	...
	public void testFieldsParametersBeanExcludedFirebird()
	{
		Update query = new Update(mFirebird);
		query.table("tablename")
