 ...
 * $Id: Test_org_apache_derby_jdbc_EmbeddedDriver.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
public class Test_org_apache_derby_jdbc_EmbeddedDriver extends TestCase
{
	public Test_org_apache_derby_jdbc_EmbeddedDriver(String name)
	{
		super(name);
	}
