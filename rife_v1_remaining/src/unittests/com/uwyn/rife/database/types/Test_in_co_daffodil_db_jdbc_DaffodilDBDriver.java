 ...
 * $Id: Test_in_co_daffodil_db_jdbc_DaffodilDBDriver.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
public class Test_in_co_daffodil_db_jdbc_DaffodilDBDriver extends TestCase
{
	public Test_in_co_daffodil_db_jdbc_DaffodilDBDriver(String name)
	{
		super(name);
	}
