 ...
 * $Id: TestImageroReaderLoader.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
public class TestImageroReaderLoader extends TestCase
{
	public TestImageroReaderLoader(String name)
	{
		super(name);
	}
	...
	{
	    ImageroReaderLoader loader = new ImageroReaderLoader();
