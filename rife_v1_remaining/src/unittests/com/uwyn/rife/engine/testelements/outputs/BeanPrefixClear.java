 ...
 * $Id: BeanPrefixClear.java 3918 2008-04-14 17:35:35Z gbevin $
 */
package com.uwyn.rife.engine.testelements.outputs;

import com.uwyn.rife.engine.Element;

public class BeanPrefixClear extends Element
{
	public void processElement()
	{
		...
		else
		{
			...
			setOutputBean(bean, "prefix_");
			
			clearOutputBean(BeanImpl.class, "prefix_");
			
			setOutput("prefix_string", "ok");
