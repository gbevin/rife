 ...
 * $Id: NamedBeanPrefixInjection.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
public class NamedBeanPrefixInjection extends Element
{
	private BeanImpl	bean;
	public void setThe_bean_prefix(BeanImpl bean) { this.bean = bean; }
