 ...
 * $Id: PropertyMismatchInBean.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
@Elem
public class PropertyMismatchInBean extends Element
{
	public final static String PROPERTY_NAME = "badname";

	@InBeanProperty(name=PROPERTY_NAME)
	public void setInBean1(BeanImpl1 var)
	{
	}
}
