 ...
 * $Id: TestGroovy2Site.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
public class TestGroovy2Site extends TestCase
{
	public TestGroovy2Site(String name)
	{
		super(name);
	}
	...
	public void testParser()
	{
		...
		SiteBuilder				builder = new SiteBuilder("groovy/test_groovy2site.groovy", resourcefinder);
		...
		FlowLink flowlink_element2 = elementinfo1.getFlowLink("ELEMENT2");
		assertSame(flowlink_element2.getTarget(), elementinfo2);
		inputs = elementinfo1.getDataLinkInputs("value1", elementinfo2, false, flowlink_element2);
		assertNotNull(inputs);
		assertEquals(inputs.size(), 1);
		assertTrue(inputs.contains("value1"));
		inputs = elementinfo1.getDataLinkInputs("value2", elementinfo2, false, flowlink_element2);
		assertNotNull(inputs);
		assertEquals(inputs.size(), 1);
		assertTrue(inputs.contains("value2"));
