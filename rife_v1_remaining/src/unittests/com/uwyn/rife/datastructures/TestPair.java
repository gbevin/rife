 ...
 * $Id: TestPair.java 3918 2008-04-14 17:35:35Z gbevin $
 */
...
public class TestPair extends TestCase
{
	...
	{
		Pair<String, Long> pair = new Pair<String, Long>("first", new Long(1434));
		assertNotNull(pair);
	...
	{
		Pair<String, Long> pair1 = new Pair<String, Long>("first1", new Long(1434));
		Pair<String, Long> pair2 = new Pair<String, Long>("first1", new Long(1434));
		Pair<String, Long> pair3 = new Pair<String, Long>("first2", new Long(83488));
		Pair<String, Long> pair4 = new Pair<String, Long>("first1", null);
		Pair<String, Long> pair5 = new Pair<String, Long>("first2", null);
		Pair<String, Long> pair6 = new Pair<String, Long>("first2", null);
		Pair<String, Long> pair7 = new Pair<String, Long>(null, new Long(1434));
		Pair<String, Long> pair8 = new Pair<String, Long>(null, new Long(83488));
		Pair<String, Long> pair9 = new Pair<String, Long>(null, new Long(83488));
		Pair<String, Long> pair10 = new Pair<String, Long>(null, null);
		Pair<String, Long> pair11 = new Pair<String, Long>(null, null);
		
		Pair<String, Integer>	pair12 = new Pair<String, Integer>("first1", new Integer(1434));
		Pair<Long, Integer>		pair13 = new Pair<Long, Integer>(new Long(1434), new Integer(1434));
		Pair<Long, String>		pair14 = new Pair<Long, String>(new Long(1434), "second1");
	...
	{
		Pair<String, Long> pair1 = new Pair<String, Long>("first", new Long(53433));
		Pair<String, Long> pair2 = new Pair<String, Long>("first", new Long(53433));
		Pair<String, Long> pair3 = new Pair<String, Long>("first2", new Long(83488));
